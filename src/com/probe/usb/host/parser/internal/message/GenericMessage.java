...
public class GenericMessage {
    ...
    public int[] getPacketData() { return packetData; }
    public DataFormat.MessageType getType() { return type; }


    public String getTitle() { return getType().name(); }
    ...
    @Override
    public String toString() { return getTitle() + " " + getValue(); }
}
